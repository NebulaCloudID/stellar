...
do_install() {
    print_banner
    echo -e "  ${BOLD}${WHITE}This will install:${RESET}"
    echo ""
    echo -e "  ${GREEN}✔${RESET}  Stellar Theme"
    echo -e "  ${GREEN}✔${RESET}  SubDomain Manager"
    echo ""
...
do_upgrade() {
    print_banner
    echo -e "  ${BOLD}${WHITE}This will upgrade:${RESET}"
    echo ""
    echo -e "  ${GREEN}✔${RESET}  Stellar Theme"
    echo -e "  ${GREEN}✔${RESET}  SubDomain Manager"
    echo ""
